...
kal_uint16 addr_data_pair_init_qtech_OV50C40[] = {
	...
	0x369d, 0x40,
	0x369e, 0x00,
	0x36a1, 0x01,//0x00 20210429 mirror_flip
	0x3700, 0x28,
	0x3701, 0x05,
	0x3702, 0x4b,
	0x3703, 0x27,
	...
	0x480f, 0x32,
	0x4815, 0x19,
	0x481b, 0x3c, //20210425 for mipi test
	0x481f, 0x32, //20210425 for mipi test
	0x4837, 0x08,
	0x484b, 0x27,
	0x4850, 0x43,
	0x4851, 0xaa,
	...
	0x588a, 0x04,
	0x5c00, 0x63,
	0x5c01, 0x05,//0x04 20210429 mirror_flip
	0x5c02, 0x00,
	0x5c03, 0x3f,
	0x5c04, 0x00,
	0x5c05, 0x54,
...
kal_uint16 addr_data_pair_custom2_OV50C40_qtech[] = {
#ifdef FACTORY_CAMERA_MODE
	0x0304, 0x01,
	0x0305, 0xe0,
	0x0307, 0x00,
...
{
	LOG_DBG("custom2_setting \n");

	OV50C40_table_write_cmos_sensor(addr_data_pair_custom2_OV50C40_qtech,
					sizeof(addr_data_pair_custom2_OV50C40_qtech) /
					sizeof(kal_uint16));
}
...
#ifdef FACTORY_CAMERA_MODE
	sensor_resolution->SensorCustom2Width = 4080;
	sensor_resolution->SensorCustom2Height = 3072;
#else
				  ...
				  UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
        LOG_INF("SENSOR_FEATURE_GET_PDAF_INFO %d\n",(UINT16) *feature_data);
