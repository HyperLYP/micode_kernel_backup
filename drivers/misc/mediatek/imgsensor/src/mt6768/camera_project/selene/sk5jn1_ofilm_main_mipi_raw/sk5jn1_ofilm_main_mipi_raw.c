...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{
		4080, 3072, 0, 0, 4080, 3072, 4080, 3072, 0, 0, 4080, 3072,
		0, 0, 4080, 3072
	},
	{
		4080, 3072, 80, 420, 3840, 2160, 1920, 1080, 0, 0, 1920, 1080,
		0, 0, 1920, 1080
	},
	{
		4080, 3072, 80, 420, 3840, 2160, 1280, 720, 0, 0, 1280, 720,
		0, 0, 1280, 720
	},
	{
		4080, 3072, 0, 0, 4080, 3072, 2000, 1500, 0, 0, 2000, 1500,
		0, 0, 2000, 1500
	},
	{
		4080, 3072, 80, 420, 3840, 2160, 1280, 720, 0, 0, 1280, 720,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kgm1sp[] = {
0x6028,	0x2400 ,
0x602A,	0x1A28 ,
0x6F12,	0x4C00 ,
0x602A,	0x065A ,
...
*sensor_id = imgsensor_info.sensor_id;
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info
			("s5kgm1sp_ofilm i2c 0x%x, sid 0x%x\n",
